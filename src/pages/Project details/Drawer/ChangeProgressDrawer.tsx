...
import Change_Progress from '../../../Forms/ChangeProgress';
...
const ChangeProgress = ({ isOpen, onClose }: ChangeProgressProps) => {
    ...
    >
      <div className="flex flex-row justify-between items-center p-4 ">
        <div className="flex flex-row gap-4">
          <h2 className="text-sm font-semibold">Change Progress</h2>
        </div>
