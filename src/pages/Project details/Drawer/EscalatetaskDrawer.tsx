...
import Escalate_Task from '../../../Forms/EscalateTaskForm';
import { theme } from '../../../theme/color';
import { EscalateTaskType, PhaseType } from '../../../Types';



type EscalateTaskProps = {
  isOpen: boolean;
  onClose: () => void;
//   task: PhaseType | null;
};

const EscalateTask = ({ isOpen, onClose }: EscalateTaskProps) => {
    ...
    >
      <div className="flex flex-row justify-between items-center p-4 ">
        <div className="flex flex-row gap-4">
          <h2 className="text-sm font-semibold">Escalate the task</h2>
        </div>
